...
[TestClass]
public class JsonEditorV2Fixture : UnitTestBase
{
    [TestInitialize]
    ...
    private void InitializeWithEmptyJson()
    {
        ...
        _SystemUnderTest = new JsonEditorV2(_PathToSampleConfigFile);
    }
    ...
    private JsonEditorV2 _SystemUnderTest;
    public JsonEditorV2 SystemUnderTest
    {
        get
        {
    ...
    public void GetSiblingValue()
    {
        ...
        _SystemUnderTest = new JsonEditorV2(jsonArray[0].ToString(), true);
